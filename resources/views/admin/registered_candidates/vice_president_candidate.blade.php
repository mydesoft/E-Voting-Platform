                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-primary">
                                <div class="card-head">
                                    <header>Registered Vice President Candidate</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="/candidate/vice-president/pdf">
                                    ...
                                    <h4>Total Records: {{$vicePresidents->count()}}</h4>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <tbody>
                                            @foreach($vicePresidents as $vicePresident)
                                                ...
                                                <td>
                                                    <a href="{{$vicePresident->candidatePath()}}">
                                                  ...
                                                  <td>
                                                    @if($vicePresident->hasSuccessfulStatus())
                                                        <button class="btn btn-success" disabled="true"><i class="fa fa-check">    
                                                       </i>Successful
                                                       </button>
                                                    @else
                                                         <a href="/status/{{$vicePresident->id}}-{{Str::slug($vicePresident->name)}}/president">
                                                 ...
                                                 <td>
                                                    <a href="{{route('deleteCandidate', $vicePresident->id)}}">
