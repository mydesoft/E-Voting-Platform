                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-primary">
                                <div class="card-head">
                                    <header>Registered Treasurer Candidate</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="/candidate/treasurer/pdf">
                                    ...
                                    <h4>Total Records: {{$treasurers->count()}}</h4>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <tbody>
                                            @foreach($treasurers as $treasurer)
                                                ...
                                                <td>
                                                    <a href="{{$treasurer->candidatePath()}}">
                                                 ...
                                                 <td>
                                                    @if($treasurer->hasSuccessfulStatus())
                                                        <button class="btn btn-success" disabled="true"><i class="fa fa-check">    
                                                       </i>Successful
                                                       </button>
                                                    @else
                                                         <a href="/status/{{$treasurer->id}}-{{Str::slug($treasurer->name)}}/president">
                                                 ...
                                                 <td>
                                                    <a href="{{route('deleteCandidate', $treasurer->id)}}">
