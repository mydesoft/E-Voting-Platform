                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Succesful Welfare</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-primary">
                                <div class="card-head">
                                    <header>Successful Candidates for Welfare</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                    ...
                                    @foreach($successful->candidates as $candidate)
                                        @if($candidate->position === $welfare)
                                                ...
                                                <td>
                                                    <a href="/mail/{{$candidate->id}}-{{Str::slug($candidate->name)}}/welfare">
                                                 ...
                                                 <td>
                                                    <a href="/admin/delete/{{$candidate->id}}-{{Str::slug($candidate->name)}}/welfare">
                                        ...
                                        <div class=" col-md-6 mb-3">  
                                             ...
                                             <a href="/mail/candidates/welfare">
                                             <button class="btn btn-info">
