                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Succesful President</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-primary">
                                <div class="card-head">
                                    <header>Successful Candidates for President</header>
                                    <div class="tools">
                                    ...
                                    <div class="row p-b-20">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="/successful/president/pdf">
                                     ...
                                     @foreach($successful->candidates as $candidate)
                                        @if($candidate->position === $president)
                                                ...
                                                <td>
                                                    <a href="/mail/{{$candidate->id}}-{{Str::slug($candidate->name)}}/president">
                                                 ...
                                                 <td>
                                                    <a href="/admin/delete/{{$candidate->id}}-{{Str::slug($candidate->name)}}/president">
                                ...
                                <div class="container">
                                        ...
                                        <div class=" col-md-6 mb-3"> 
                                             <h4>To Send Mail to all the Candidates:</h4>
                                                     ...
                                                     <a href="/mail/candidates/president">
                                                        <button class="btn btn-info">
