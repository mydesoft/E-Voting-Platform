                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Succesful Treasurer</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-primary">
                                <div class="card-head">
                                    <header>Successful Candidates for Treasurer</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="/successful/treasurer/pdf">
                                    ...
                                    @foreach($successful->candidates as $candidate)
                                        @if($candidate->position === $treasurer)
                                                ...
                                                <td>
                                                    <a href="/mail/{{$candidate->id}}-{{Str::slug($candidate->name)}}/treasurer">
                                                 ...
                                                 <td>
                                                    <a href="/admin/delete/{{$candidate->id}}-{{Str::slug($candidate->name)}}/treasurer">
                                        ...
                                        <div class=" col-md-6 mb-3">  
                                             ...
                                             <a href="/mail/candidates/treasurer">
                                             <button class="btn btn-info">
