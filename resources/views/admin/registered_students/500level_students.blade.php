...
@section('title', 'Registered 500Level Students')
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Registered 500 Level Students</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>Registered 500 Level Students</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                    ...
                                    @if($_500LevelStudentDatas->count() > 0 )
                                                ...
                                                <td class="valigntop">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="{{$_500LevelStudentData->edit()}}" class="text-info">
                                                                    <i class="fa fa-edit"></i> Edit </a>
                                                            </li>
                                                            <li>
                                                                <a href="/registered_student/{{$_500LevelStudentData->id}}/delete" class="text-danger">
