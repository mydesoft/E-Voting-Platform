...
@section('title', 'Registered 300Level Students')
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Registered 300 Level Students</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>Registered 300 Level Students</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                    ...
                                    @if($_300LevelStudentDatas->count() > 0 )
                                                ...
                                                <td class="valigntop">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="{{$_300LevelStudentData->edit()}}" class="text-info">
                                                                    <i class="fa fa-edit"></i> Edit </a>
                                                            </li>
                                                            <li>
                                                                <a href="/registered_student/{{$_300LevelStudentData->id}}/delete" class="text-danger">
