...
@section('title', 'Registered 400Level Students')
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Registered 400 Level Students</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>Registered 400 Level Students</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                    ...
                                    @if($_400LevelStudentDatas->count() > 0 )
                                                ...
                                                <td class="valigntop">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="{{$_400LevelStudentData->edit()}}" class="text-info">
                                                                    <i class="fa fa-edit"></i> Edit </a>
                                                            </li>
                                                            <li>
                                                                <a href="/registered_student/{{$_400LevelStudentData->id}}/delete" class="text-danger">
